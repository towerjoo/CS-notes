...
.. note::
   ...
   这是支持with..as..语句的协议，即实现__enter__,__exit__
   如：
        ...
        class TraceBlock:
            ...
            def __exit__(self, exec_type, exec_value, exec_tb):
                if exec_type is None:
                    print "exit normally." # no exception 
                else:
                    print 'raise an exception', exec_type
                    return False    #传播异常
...
如果上述代码中的as VAR部分没有，则VAR=部分也就没有，但mgr等依旧存在。
更多请参考： `PEP343 <http://www.python.org/dev/peps/pep-0343/>`_
